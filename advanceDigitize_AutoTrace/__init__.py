...
def classFactory(iface):  # pylint: disable=invalid-name
    """Load AdvanceDigitize_AutoTrace class from file AdvanceDigitize_AutoTrace.

    :param iface: A QGIS interface instance.
    :type iface: QgsInterface
    """
    #
    from .advanceDigitize_AutoTrace import AdvanceDigitize_AutoTrace
    return AdvanceDigitize_AutoTrace(iface)
